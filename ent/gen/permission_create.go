...
func (pc *PermissionCreate) AddUserPermissionIDs(ids ...uint64) *PermissionCreate {
...
func (pc *PermissionCreate) check() error {
	...
	if _, ok := pc.mutation.Resource(); !ok {
		return &ValidationError{Name: "resource", err: errors.New(`gen: missing required field "Permission.resource"`)}
	}
	...
	if _, ok := pc.mutation.Action(); !ok {
		return &ValidationError{Name: "action", err: errors.New(`gen: missing required field "Permission.action"`)}
	}
	...
	if _, ok := pc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`gen: missing required field "Permission.created_at"`)}
	}
	if _, ok := pc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`gen: missing required field "Permission.updated_at"`)}
	}
	return nil
}
