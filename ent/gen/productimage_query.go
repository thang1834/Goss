...
func (piq *ProductImageQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (piq *ProductImageQuery) FirstIDX(ctx context.Context) uint64 {
...
func (piq *ProductImageQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (piq *ProductImageQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (piq *ProductImageQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (piq *ProductImageQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := piq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(productimage.FieldImageURL).
//		Aggregate(gen.Count()).
//		Scan(ctx, &v)
...
//
//	client.ProductImage.Query().
//		Select(productimage.FieldImageURL).
//		Scan(ctx, &v)
...
func (piq *ProductImageQuery) loadProduct(ctx context.Context, query *ProductQuery, nodes []*ProductImage, init func(*ProductImage), assign func(*ProductImage, *Product)) error {
	...
	nodeids := make(map[uint64][]*ProductImage)
	for i := range nodes {
...
func (piq *ProductImageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(productimage.Table, productimage.Columns, sqlgraph.NewFieldSpec(productimage.FieldID, field.TypeUint64))
	_spec.From = piq.sql
