...
func (rq *ReviewQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *ReviewQuery) FirstIDX(ctx context.Context) uint64 {
...
func (rq *ReviewQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (rq *ReviewQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (rq *ReviewQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (rq *ReviewQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (rq *ReviewQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Review, init func(*Review), assign func(*Review, *User)) error {
	...
	nodeids := make(map[uint64][]*Review)
	for i := range nodes {
