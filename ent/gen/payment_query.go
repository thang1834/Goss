...
func (pq *PaymentQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PaymentQuery) FirstIDX(ctx context.Context) uint64 {
...
func (pq *PaymentQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PaymentQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (pq *PaymentQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (pq *PaymentQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
