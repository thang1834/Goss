...
func (tx *Tx) init() {
	...
	tx.DiscountCategory = NewDiscountCategoryClient(tx.config)
	tx.DiscountProduct = NewDiscountProductClient(tx.config)
	...
	tx.WishlistItem = NewWishlistItemClient(tx.config)
}
