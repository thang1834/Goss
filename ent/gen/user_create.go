...
func (uc *UserCreate) AddRoles(u ...*UserRole) *UserCreate {
...
func (uc *UserCreate) AddPermissionIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddPermissionIDs(ids...)
	return uc
}

// AddPermissions adds the "permissions" edges to the UserPermission entity.
func (uc *UserCreate) AddPermissions(u ...*UserPermission) *UserCreate {
	ids := make([]uint64, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
func (uc *UserCreate) AddWishlistIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddWishlistIDs(ids...)
	return uc
}

// AddWishlists adds the "wishlists" edges to the Wishlist entity.
func (uc *UserCreate) AddWishlists(w ...*Wishlist) *UserCreate {
	ids := make([]uint64, len(w))
	for i := range w {
		ids[i] = w[i].ID
	}
	return uc.AddWishlistIDs(ids...)
}

// AddReviewIDs adds the "reviews" edge to the Review entity by IDs.
func (uc *UserCreate) AddReviewIDs(ids ...uint64) *UserCreate {
...
func (uc *UserCreate) AddVoucherIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddVoucherIDs(ids...)
	return uc
}

// AddVouchers adds the "vouchers" edges to the UserVoucher entity.
func (uc *UserCreate) AddVouchers(u ...*UserVoucher) *UserCreate {
	ids := make([]uint64, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return uc.AddVoucherIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.WishlistsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.VouchersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
